...
function CitySelector() {
  ...
  return (
    <div className='bg-gray-500 p-6'>
      <select className="flex items-center justify-center text-center w-64 h-12 bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-base font-medium text-black hover:border-red-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" 
